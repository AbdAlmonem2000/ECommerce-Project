            ...
            <div data-aos="zoom-in" data-aos-duration="1000" className="bg-[#fff] container flex flex-col justify-start items-center py-6 mt-5 pt-11 w-full mx-auto">
                <div className="container">
                    ...
                    <div className="container py-1">
                        ...
                        <form onSubmit={formik.handleSubmit} className="container md:w-2/3 w-full my-96 mx-auto relative py-1 mt-1">
                            ...
                            <div className="relative z-0 md:w-1/2 w-11/12 mx-auto group">
                                <div className="flex w-full items-center">
                                    ...
                                    {loading ? <button className="btn">
                                        <span className="font-bold">Please wait <i className="fas fa-spinner fa-spin mx-3"></i></span>
